...
GoStack is a full-stack Web framework for Go. It is a **batteries-included** web framework — meaning everything you need to build a complete application (routing, database access, authentication, queuing, caching, mail, file storage, and more) is built-in and ready to use the moment you scaffold a new project.
...
You should see the GoStack command list printed to your terminal. If your terminal says `gost: command not found`, see the [Troubleshooting](https://www.google.com/search?q=%23troubleshooting) section at the bottom of this page.
...
**Step 1 — Close your terminal completely and open a brand new one.** This is the fix for most people. Your terminal needs to be restarted to recognize newly installed tools. Once you have reopened it, run `gost` again.
